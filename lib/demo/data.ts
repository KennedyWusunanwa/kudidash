...
export const demoCustomers = [
  {
    ...
    description: "Retail customer with monthly bookkeeping invoices.",
    is_active: true,
    created_at: NOW,
    updated_at: NOW,
  },
  {
    ...
    billing_address: "Plot 7 Industrial Area\nTema, Ghana",
    description: "Manufacturing client for audit and advisory work.",
    is_active: true,
    created_at: NOW,
    updated_at: NOW,
  },
